...
@contextmanager
def write_start_and_end(filename, start="{", end="}"):
    """Context manager to write start and end content to a file."""
    with open(filename, "w") as file:
        file.write(start + "\n")  # Write the opening brace
    try:
        yield  # Allow the main operation to execute
    finally:
        with open(filename, "a") as file:
            file.write("\n" + end)  # Write the closing brace
